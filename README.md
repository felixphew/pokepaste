PokePaste
=======
<em>Pokepaste is a simple pastebin, with a clean interface, that supports
...
(up until now) has had support for syntax-highlighting it.</em>
...
help testing PokePaste v3 across different browsers.</em>
...
it contains the settings for URL encryption and database connection.</em>
Example:
...
more information on the database connection parameters.</em>
...
of some kind (nginx works well).</em>
...
Pokémon and Pokémon character names are trademarks of Nintendo.</em>
